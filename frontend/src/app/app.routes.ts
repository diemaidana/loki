...
export const routes: Routes = [
    ...
    {path: 'offers', component: ListProducts, canActivate: [authGuardGuard], title:"Mis ofertas"},
    {path: 'purchases', component: ListProducts, canActivate: [authGuardGuard], title:"Mis Compras"},
    {path: '**', redirectTo: ''}
];
